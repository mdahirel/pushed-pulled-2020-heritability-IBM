...
background_env <- ggplot() + 
  ...
  theme(
    ...
    panel.background = element_rect(fill="#66c2a5")
  )
```
...
background_fec <- ggplot() + 
  ...
  theme(
    ...
    panel.background = element_rect(fill="#8da0cb")
  )
```
...
p_summary <- ggplot()+ 
  geom_textbox(aes(
    label= paste("<i style='color:#d95f02'>35 × 7 × 1</i> × ",
                 "<i style='color:#1b9e77'>3 × 1</i> × ",
                 "<i style='color:#7570b3'>2</i>", " = **1470** sets of initial conditions <br>",

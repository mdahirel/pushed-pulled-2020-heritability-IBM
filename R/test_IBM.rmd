...
tab <- exp_h2 %>%
  ...
  median_dmax = na_if(median_dmax, -999),
  median_slope = na_if(median_slope, -999),
  median_midpoint = na_if(mean_midpoint,-999),
  median_d0 = na_if(median_d0, -999),
  median_d1 = na_if(median_d1, -999),
  median_dK = na_if(median_dK, -999),
  median_maxslope = na_if(median_maxslope, -999),
  median_avgslope0_K = na_if(median_avgslope0_K, -999),
  median_avgslope1_K = na_if(median_avgslope1_K, -999),
  var_dmax = na_if(var_dmax, -999),
  var_slope = na_if(var_slope, -999),
  var_midpoint = na_if(var_midpoint,-999),
  var_d0 = na_if(var_d0, -999),
  var_d1 = na_if(var_d1, -999),
  var_dK = na_if(var_dK, -999),
  var_maxslope = na_if(mean_maxslope, -999),
  var_avgslope0_K = na_if(mean_avgslope0_K, -999),
  var_avgslope1_K = na_if(mean_avgslope1_K, -999),

...
trt_grid <- tibble(
   VP_logit_dmax = c(0, 1.5, 1.5, 1.5, 1.5),
   VP_logit_slope = c(0, 1.5, 1.5, 1.5, 1.5),
   VP_logit_midpoint =c(0, 1.5, 1.5, 1.5, 1.5),
   heritability = c(0, 0, 0.33, 0.66, 1)
  ...
  dispersal_mortality = c(0.1),  # test 0.5 ?

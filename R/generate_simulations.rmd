...
nl_object@experiment <- experiment(
  ...
  # the evalticks = 1 is to guarantee something is saved everytime
  # even in runs that never produce any valid value for one of 
  # code crashes if some metrics.patches report nothing
  metrics = c("ticks",
              "start_d0", "start_dK","start_davg_0_K",
              "start_slopeA_0_K", "start_slopeA_0_avg"),

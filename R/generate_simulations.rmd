...
trt_grid <- tibble(
  ...
  ## and we keep in the range defined in Kun/Scheuring for instance
...
nl_object@experiment <- experiment(
  ...
  metrics.patches = c("pxcor", "founding",
                      ...
                      "var_d0","var_dK", "var_davg_0_K",
                      "mean_slopeA_0_K", "mean_slopeA_0_avg", "mean_uncond_0_K",
                      "var_slopeA_0_K", "var_slopeA_0_avg", "var_uncond_0_K"),
  constants = list(
    "duration" = duration
  ),

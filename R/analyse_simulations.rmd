...
lmer_fix=lmer(obs_v/120~vstar+(1|scenario),data=tab_fix|> filter(start_slope==0))
lmer_noevo=lmer(obs_v/120~vstar+(1|scenario),data=tab_noevo|> filter(start_slope==0))

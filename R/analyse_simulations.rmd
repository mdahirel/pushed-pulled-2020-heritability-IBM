...
R2_velocity=rbind(R2_100,R2_100_noDDD,R2_00,R2_00_noDDD) %>% 
  mutate(model_name=c("mod_100","mod_100_noDDD","mod_00","mod_00_noDDD"))
...
save(list=c("mod_div_100","mod_div_100_noDDD",
            "mod_div_00","mod_div_00_noDDD"), 
...
save(list=c("loo_div_100","loo_div_100_noDDD",
            "loo_div_00","loo_div_00_noDDD"), 
     file=here("R_output","loo_diversity.Rdata"))
    }

loo_compare(loo_div_00,loo_div_100,loo_div_00_noDDD,loo_div_100_noDDD) %>% 
  as.data.frame() %>% 
  rownames_to_column(var="model_name") %>% 
  as_tibble() %>% 
             mutate(is.evo=case_when(str_detect(model_name,"_100")~"after evolution (t = 100)",
...
R2_diversity=rbind(R2_div_100,R2_div_100_noDDD,R2_div_00,R2_div_00_noDDD) %>% 
  mutate(model_name=c("mod_div_100","mod_div_100_noDDD","mod_div_00","mod_div_00_noDDD"))

...
mod_gen_fixBB <- brm(bf(lagging_pre|trials(edge_pre)~ start_Kslope * Mort * Fec  + (1|scenario),
                        phi ~ start_Kslope * Mort * Fec  + (1|scenario)),
                  family=beta_binomial,
                  data=tab_fix,backend="cmdstanr",
        seed=42,
                  prior=c(
...
pp_check(mod_gen_noevoB,"stat_2d") #some evidence of overdispersion?
...
pp_check(mod_gen_noevoBB0,"stat_2d") # no overdisp
...
pp_check(mod_gen_evoB,"stat_2d") #some evidence of overdispersion?
...
pp_check(mod_gen_evoBB0,"stat_2d") # no overdisp

...
fig3_a <- ggplot(tab_fix)+
  ...
  scale_fill_viridis("&Delta;<sub>K-0</sub>", option = "inferno")+
  scale_x_continuous("")+
...
fig4_a <- ggplot(tab_evo)+
  ...
  scale_fill_viridis("**Initial** &Delta;<sub>K-0</sub>", option = "inferno")+
  scale_x_continuous("")+
  scale_y_continuous("Observed velocity")+
...
fig4_b <- ggplot(tab_evo)+
  ...
  scale_fill_viridis("**Final** &Delta;<sub>K-0</sub>", option = "inferno")+
  scale_x_continuous("Theoretical velocity if density-independent dispersal (i.e. &Delta;<sub>K-0</sub> = 0)")+
  scale_y_continuous("Observed velocity")+

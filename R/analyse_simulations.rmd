...
test$advance=test$front_120-test$front_100

mod100=brm(bf((advance+1)~
          (scale(mean_d0_100)+scale(mean_avgslope_100))*mortality),
        family=cumulative,data=test,chains=4,seed=42,iter=1000,backend="cmdstanr",
        prior=c(
          set_prior("normal(0,1.5)",class="Intercept"),
          set_prior("normal(0,1)",class="b")
        ))

mod100x=brm(bf((advance)|trials(20)~
          (scale(mean_d0_100)+scale(mean_avgslope_100))*mortality),
        family=binomial,data=test,chains=4,seed=42,iter=1000,backend="cmdstanr",
        prior=c(
          set_prior("normal(0,1.5)",class="Intercept"),
          set_prior("normal(0,1)",class="b")
        ))
...
mod100y=brm(bf((advance+1)~
          (scale(mean_d0_100)+mean_avgslope_100)*mortality),
          ## we don't scale slope as there is already meaningful zero
          ## but maybe we should at least / it by SD??
        family=sratio,data=test,chains=4,seed=42,iter=200,backend="cmdstanr",
        prior=c(
          set_prior("normal(0,1.5)",class="Intercept"),
          set_prior("normal(0,1)",class="b")
        ))
...
mod00=gam(cbind((front_120-front_100),20-(front_120-front_100))~
          s(start_d0, by = mortality,k=10)+
          s(start_avgslope,by=mortality,k=10)+
          s(start_uncond,by=mortality,k=10)+
          mortality,
        family=binomial,data=test,method="REML")


mod10=gam(cbind((front_120-front_100),20-(front_120-front_100))~
          s(mean_d0_10, by = mortality,k=10)+
          s(mean_avgslope_10,by=mortality,k=10)+
          s(mean_uncond_10,by=mortality,k=10)+
          mortality,
        family=binomial,data=test,method="REML")

mod20=gam(cbind((front_120-front_100),20-(front_120-front_100))~
          s(mean_d0_20, by = mortality,k=10)+
          s(mean_avgslope_20,by=mortality,k=10)+
          s(mean_uncond_20,by=mortality,k=10)+
          mortality,
        family=binomial,data=test,method="REML")

mod40=gam(cbind((front_120-front_100),20-(front_120-front_100))~
          s(mean_d0_40, by = mortality,k=10)+
          s(mean_avgslope_40,by=mortality,k=10)+
          s(mean_uncond_40,by=mortality,k=10)+
          mortality,
        family=binomial,data=test,method="REML")

mod60=gam(cbind((front_120-front_100),20-(front_120-front_100))~
          s(mean_d0_60, by = mortality,k=10)+
          s(mean_avgslope_60,by=mortality,k=10)+
          s(mean_uncond_60,by=mortality,k=10)+
          mortality,
        family=binomial,data=test,method="REML")

mod80=gam(cbind((front_120-front_100),20-(front_120-front_100))~
          s(mean_d0_80, by = mortality,k=10)+
          s(mean_avgslope_80,by=mortality,k=10)+
          s(mean_uncond_80,by=mortality,k=10)+
          mortality,
        family=binomial,data=test,method="REML")

mod100=gam(cbind((front_120-front_100),20-(front_120-front_100))~
          s(mean_d0_100, by = mortality,k=10)+
          s(mean_avgslope_100,by=mortality,k=10)+
          s(mean_uncond_100,by=mortality,k=10)+
          mortality,
        family=binomial,data=test,method="REML")

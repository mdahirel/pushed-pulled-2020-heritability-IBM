...
- however, this does not reduce the available range of density-dependence for analyses that rely on only successful expansions, and most replicates with $\Delta_{K-0}$ successfully expand.
...
**Figure S6.1.** Relationship between observed expansion velocities and expected theoretical velocities $v^*$, in expansions where evolution was possible but only density-dependence traits ($\alpha$ and $\beta$) were allowed to evolve. Legend is otherwise identical to **Fig. S6.2**.
